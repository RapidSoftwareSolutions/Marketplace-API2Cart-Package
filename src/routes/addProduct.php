...
$app->post('/api/API2Cart/addProduct', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'api_key','storeKey'=>'store_key','name'=>'name','model'=>'model','price'=>'price','description'=>'description','attributeName'=>'attribute_name','shippingTemplateId'=>'shipping_template_id','condition'=>'condition','listingDuration'=>'listing_duration','paymentMethods'=>'payment_methods','returnAccepted'=>'return_accepted','shippingDetails'=>'shipping_details','paypalEmail'=>'paypal_email','attributeSetName'=>'attribute_set_name'];
