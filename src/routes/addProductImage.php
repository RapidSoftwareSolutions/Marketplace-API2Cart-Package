...
$app->post('/api/API2Cart/addProductImage', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','storeKey'=>'storeKey','productId'=>'productId','type'=>'type','url'=>'url'];
    $optionalParams = ['imageName'=>'imageName','label'=>'label','mime'=>'mime','position'=>'position','image'=>'image'];
    $bodyParams = [
