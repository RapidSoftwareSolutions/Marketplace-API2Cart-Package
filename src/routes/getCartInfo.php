...
$app->post('/api/API2Cart/getCartInfo', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['store_id','api_key','store_key','params','exclude']
    ];
    ...
    $query_str = "https://api.api2cart.com/v1.0/cart.info.json";
