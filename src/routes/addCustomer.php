...
$app->post('/api/API2Cart/addCustomer', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','storeKey','email','firstName','lastName']);
    ...
    $query_str = "https://api.api2cart.com/v1.0/customer.add.json";
