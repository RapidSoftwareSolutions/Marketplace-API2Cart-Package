...
$app->post('/api/API2Cart/disconnectCart', function ($request, $response) {
    ...
    $optionalParams = ['deleteBridge'=>'delete_bridge'];
    $bodyParams = [
       'query' => ['delete_bridge','api_key','store_key']
    ];
    ...
    $query_str = "https://api.api2cart.com/v1.0/cart.disconnect.json";
