...
$app->post('/api/API2Cart/listCartGiftcards', function ($request, $response) {
    ...
    $optionalParams = ['storeId'=>'store_id','start'=>'start','count'=>'count','params'=>'params','exclude'=>'exclude'];
    $bodyParams = [
       'query' => ['store_id','api_key','store_key','start','count','params','exclude']
    ];
