...
$app->post('/api/API2Cart/findProduct', function ($request, $response) {
    ...
    $optionalParams = ['findValue'=>'find_value','findWhere'=>'find_where','find_params'=>'find_params','findWhat'=>'find_what'];
    $bodyParams = [
       'query' => ['find_what','find_params','find_where','find_value','api_key','store_key']
    ];
    ...
    $query_str = "https://api.api2cart.com/v1.0/product.find.json";
