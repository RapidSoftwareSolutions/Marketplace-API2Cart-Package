...
$app->post('/api/API2Cart/listAbandonedOrders', function ($request, $response) {
    ...
    $optionalParams = ['customerId'=>'customer_id','customerEmail'=>'customer_email','start'=>'start','count'=>'count','params'=>'params','exclude'=>'exclude','createdFrom'=>'created_from','createdTo'=>'created_to','modifiedFrom'=>'modified_from','modifiedTo'=>'modified_to'];
    $bodyParams = [
